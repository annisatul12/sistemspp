...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->query($query) === TRUE) {
        echo "<script>
            alert('Data Spp Berhasil Diedit!');
            window.location.href = 'list_spp.php';
        </script>";
        exit;
    } else {
        echo "<script>
            alert('Data Spp Gagal Diedit!');
            window.location.href = 'list_spp.php';
        </script>";
    }
}
							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  action="" method="post">
                                        ...
                                        ?>
                                        <input type="hidden" name="id" value="<?php echo $kelas['id_spp']; ?>">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Tahun <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input name="tahun" value="<?php echo $kelas['tahun']; ?>" type="text" id="first-name" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="last-name" name="nominal" value="<?php echo $kelas['nominal']; ?>" required="required" class="form-control">
											</div>
										</div>
