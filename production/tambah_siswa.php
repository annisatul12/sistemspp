...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
 ...
 $password = $username . mt_rand(100, 999);
        ...
        if ($stmt) {
            $stmt->bind_param("iisissi", $nisn, $nis, $nama, $kelas, $alamat, $no_telepon, $id_spp);
            if ($stmt->execute()) {
                echo "<script>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Halaman Tambah Data Siswa</h3>
						</div>
								...
								<div class="x_content" style="background-color: white;">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  action="" method="post">
                                        ...
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input name="nis" type="tel" id="nis" required="required" class="form-control" maxlength="8">
											</div>
										</div>
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input name="nama" type="text" id="nama" required="required" class="form-control ">
											</div>
										</div>
                                        <div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input name="alamat" type="text" id="alamat" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input name="no telepon" type="tel" id="first-name" required="required" class="form-control" maxlength="13">
											</div>
										</div>
