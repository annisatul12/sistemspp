    ...
    if (isset($_POST['submit'])) {
        ...
        if ($stmt) {
            ...
            echo "<script>
                    ...
                    window.location.href= 'tambah_spp.php';
                  </script>";
        }
    }
}
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  action="" method="post">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input name="tahun" type="text" id="first-name" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="last-name" name="nominal" required="required" class="form-control">
											</div>
										</div>
