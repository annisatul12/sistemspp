                    ...
                    <table class="table">
                      ...
                      <tbody>
						...
						<tr>
							...
							<td>
								<a href="hapus_pembayaran.php?id_pembayaran=<?php echo $user['id_pembayaran']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Kamu Yakin?')"><i class="fa fa-trash"></i></a>
								<a href="edit_pembayaran.php?id=<?php echo $user['id_pembayaran']; ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
